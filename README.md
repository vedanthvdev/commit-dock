...
> **Status:** current release is **`v0.6.0`** (Phase 5: amend previous commit with HEAD message defaulting). Next: push and force-with-lease flow. See [CHANGELOG.md](CHANGELOG.md).

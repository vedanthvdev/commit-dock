...
> **Status:** current release is **`v0.5.0`** (Phase 4: commit message and plain commit with selection-synced index). Next: amend and message defaulting. See [CHANGELOG.md](CHANGELOG.md).
